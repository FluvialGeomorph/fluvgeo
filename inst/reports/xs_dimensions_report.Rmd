...
for (j in as.integer(levels(as.factor(xs_pts$Seq)))) {
    # Create the cross sectiion map
    print(fluvgeo::map_xs(cross_section = params$xs_dims_planform,
                      xs_number = j,
                      dem = params$dem,
                      banklines = params$banklines,
