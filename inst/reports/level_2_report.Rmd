...
```{r, xs_metrics_plot, eval=FALSE, echo=FALSE, results='asis', fig.width=7, fig.height=8, fig.cap="Cross Section Metrics Plot. ", warning=FALSE}
print(fluvgeo::xs_metrics_plot(reach_xs_dims = params$xs_dims_planform@data, 
                               features_sp = params$features,
                               label_xs = params$label_xs))
```

## Width Depth Ratio
```{r, wdr_map, eval=FALSE, echo=FALSE, results='asis', fig.width=7, fig.height=8, fig.cap="Width depth Ratio Map", warning=FALSE}
...
```{r wdr_plot, eval=FALSE, echo=FALSE, fig.width=7, fig.cap="Width Depth Ratio Graph", warning=FALSE}
...
```{r, regional_curve_graph, eval=FALSE, echo=FALSE, results='asis', fig.width=7, fig.height=8, fig.cap="Regional Hydraulic Geometry Curves"}
...
```{r, xs_plots, eval=FALSE, echo=FALSE, results='asis', fig.width=7, fig.height=4, warning=TRUE}
