...
if(params$show_xs_map) {
  # Get dem raster
  dem_arc <- arc.open(params$dem)
  dem_wkt2 <- rgdal::showSRID(dem_arc@sr$WKT)
  dem_raster <- arcgisbinding::as.raster(arc.raster(dem_arc))
  raster::crs(dem_raster) <- sp::CRS(SRS_string = dem_wkt2)
}
