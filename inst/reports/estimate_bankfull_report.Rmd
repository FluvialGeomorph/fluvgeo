...
# Estimate Bankfull: `r params$stream`
...
```{r, xs_plots, echo=FALSE, results='asis', message=FALSE, warning=FALSE, fig.width=7, fig.height=7}
# Iterate through xs's, create plot, calculate xs dimensions, print RHG table
