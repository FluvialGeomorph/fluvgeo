...
```{r cross_section_plots, echo=FALSE, results='asis',fig.width=6, fig.height=10, warning=FALSE, error=FALSE, message=FALSE}
# Get dem raster
dem_rast <- fluvgeo::arc_raster2SpatRaster(raster_path = report_params$dem)

# Ensure that cross sections are sequentially ordered
cross_section <- dplyr::arrange(report_params$xs_sf, Seq)
