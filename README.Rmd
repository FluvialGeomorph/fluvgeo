...
note that this repository includes configuration for compatible extensions. 
See [.vscode/README.md](.vscode/README.md) for information about GitHub 
Copilot Chat compatibility with Positron OSS-Code 1.103.0.
