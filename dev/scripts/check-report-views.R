...
file.copy(c("R/study_context_report.R", "R/revise_study_context.R", "R/define_study_streams.R", "R/add_study_reaches.R", "R/set_study_reach_areas.R", "R/record_study_survey_event.R", "R/associate_study_terrain.R", "R/record_study_terrain_metadata.R"), file.path(docs, "R"))
roxygen2::roxygenise(docs, roclets = "rd", load_code = roxygen2::load_source)
for (topic in c("study_context_report.Rd", "revise_study_context.Rd", "define_study_streams.Rd", "add_study_reaches.Rd", "set_study_reach_areas.Rd", "record_study_survey_event.Rd", "associate_study_terrain.Rd", "record_study_terrain_metadata.Rd"))
