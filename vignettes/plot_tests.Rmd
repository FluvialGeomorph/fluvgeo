...
sen_xs_dimensions <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/Senachwine/Data/Watershed/03_SenachwineCreekMainstem/SenachwineCreekMainstem.gdb/riffle_dims_104")

# Import infrastructure feature class
sen_infrastructure <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/Senachwine/Data/Watershed/03_SenachwineCreekMainstem/SenachwineCreekMainstem.gdb/infrastructure")
...
sen01_features <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/Senachwine/Data/Watershed/01_LowerSenachwineCreek/LowerSenachwineCreek.gdb/features")
...
bankline_points_fc <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/Senachwine/Data/Watershed/01_LowerSenachwineCreek/LowerSenachwineCreek.gdb/bankline_points")
...
```{r}
# Import xs dimensions feature class
sen01_xs_points <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/Senachwine/Data/Watershed/01_LowerSenachwineCreek/LowerSenachwineCreek.gdb/riffle_channel_points")
...
# Import bankline points feature class
banklines <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/Senachwine/Data/Watershed/01_LowerSenachwineCreek/LowerSenachwineCreek.gdb/banklines")
...
```{r}
# Import xs dimensions feature class
cam_xs_points <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/CampbellsCreek/CampbellCreek.gdb/riffle_points")

# Convert to a dataframe
cam_xs_pts <- cam_xs_points@data

# Import xs dimensions feature class
cam_xs_dimensions <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/CampbellsCreek/CampbellCreek.gdb/riffle_dims_planform")

# convert tot data frame
cam_xs_dimensions_df <- cam_xs_dimensions@data

# Import bankline points feature class
cam_banklines <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/CampbellsCreek/CampbellCreek.gdb/banklines")

cam_dem_path <- "Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/CampbellsCreek/CampbellCreek.gdb/dem_hydro"

# Import xs features feature class
cam_features <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/CampbellsCreek/CampbellCreek.gdb/features")
...
sen01_flowline <- fgm::arc2sp("Z:/Work/Office/Regional/ERDC/EMRRP_Sediment/Senachwine/Data/Watershed/01_LowerSenachwineCreek/LowerSenachwineCreek.gdb/flowline")
```
...
reach_metric_map(width_depth_ratio, flowline, xs_dimensions)
```

```{r xs_metric_plot, fig.width=6}
xs_metric_plot(width_depth_ratio, sen01_xs_dimensions_df)
```
